...
import { faSquareFacebook, faSquareYoutube, faLinkedin, faInstagram } from "@fortawesome/free-brands-svg-icons";
    ...
    <div className="Footer">
      ...
      <div className="FLists">
        ...
        <ul className="FList">
          ...
          <li className="fListItem"><FontAwesomeIcon className="logo_Youtube" icon={faSquareYoutube} /><a className="text1" href="#"> Youtube</a></li>
          <li className="fListItem"><FontAwesomeIcon className="logo_Fa" icon={faSquareFacebook} /><a className="text1" href="#"> Facebook</a></li>
        </ul>
      </div>
      ...
      <div className="FLists">
        ...
        <ul className="FList">
          <li className="fListItem">
            <img style={{height: "40px", marginRight: "10px"}} src="./src/assets/img/momo.png" alt="MoMo" />
            <span className="text1">MOMO</span>
          </li>
          <li className="fListItem">
          <img style={{height: "40px", marginRight: "10px", marginTop : "10px"}} src="./src/assets/img/vnPay.png" alt="VnPay" />
